                    ...
                    <table class="table table-hover table-striped table-responsive">
                          ...
                          <tbody>
                              <?php
                                    ...
                                    INNER JOIN user u ON
                                        ord.user_id = u.id
                                    order BY ord.status DESC LIMIT {$offset},{$limit};";
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_blank" href="<?php echo 'uploads/'.$row['img'] ?>"><img src="<?php echo 'uploads/'.$row['img'] ?>" style="width:50px"></img></a>
                                                </td>                                  
                                                <td><?php echo $row['prod_name'] ?></td>
                                                <td><?php echo $row['f_name']." ".$row['l_name'] ?></td>
                                                <td><?php echo $row['email'] ?></td>
                                                <td><?php echo $row['mobile'] ?></td>
                                                <td><?php echo $row['deal_price'] * $row['qty']?></td>
                                                <td><?php echo $row['qty'] ?></td>
                                                <td><?php echo $row['date'] ?></td>
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" <?php if($row['status'] == '1') echo 'checked' ?> onclick="updatestatus('orders','status',<?php echo $row['id']?>, <?php echo $row['status'] ?>)">
                                                ...
                                                <!-- Delete brand -->
                                                    <button type="button" class="btn">
                                                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                                            ...
                                                            <button type="submit" name="delete_order" class="border-0"><i class="text-danger text-center font-25 fad fa-trash-alt"></i></button>
                                                        </form>
                                                    </button>    
                                                </td>
                                            </tr>
                      ...
                      <?php
                        ...
                        if(mysqli_num_rows($result1) > 0){
                            ...
                            if($page > 1){
                                echo '<li class="page-item active"><a class="page-link" href="order.php?page='.($page - 1).'"><i class="fad fa-angle-double-left"></i></a></li>';
                            }else{
                            ...
                            for($i = 1; $i <= $totalpages; $i++){
                                ...
                                echo '<li class="page-item '.$active.'"><a class="page-link" href="order.php?page='.$i.'">'.$i.'</a></li>';
                            }
                            if($page < $totalpages){
                                echo '<li class="page-item active"><a class="page-link" href="order.php?page='.($page + 1).'"><i class="fad fa-chevron-double-right"></i></a></li>';
                            }else{
